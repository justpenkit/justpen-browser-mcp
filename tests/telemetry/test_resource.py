...
def test_required_session_cannot_be_satisfied_by_resource_attribute():
    config = read_config(
        {
            PREFIX + "ENABLED": "true",
    ...
    disabled = read_config({PREFIX + "REQUIRE_SESSION": "true"})
