---
description: Read, set, and clear cookies and browser storage.
---
...
## browser_clear_cookies { #browser_clear_cookies }
...
## browser_get_local_storage { #browser_get_local_storage }
