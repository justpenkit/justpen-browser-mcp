...
## browser_create_instance { #browser_create_instance }
...
`BROWSER_MCP_*` env vars or CLI flags — see [Configuration](../getting-started/configuration.md)).
Passing a non-`None` value overrides that default for this instance only,
leaving every other instance and the server default untouched. The full
...
## browser_destroy_instance { #browser_destroy_instance }
...
## browser_list_instances { #browser_list_instances }
...
| -------------- | ------------- | --------------------------------------------------------------------------------------------------------------------- |
| `name`         | `str`         | Instance name.                                                                                                        |
| `status`       | `str`         | Instance status, `"live"` or `"crashed"` — see [crash detection](../concepts/instances-isolation.md#crash-detection). |
...
| -------------- | ------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `name`         | `str`         | Instance name.                                                                                                             |
| `status`       | `str`         | Instance status, e.g. `"live"` or `"crashed"` — see [crash detection](../concepts/instances-isolation.md#crash-detection). |
| `mode`         | `str`         | `"ephemeral"` or `"persistent"`.                                                                                           |
| `profile_dir`  | `str \| null` | Absolute path to the profile directory, or `null` for ephemeral instances.                                                 |
| `page_count`   | `int`         | Number of open tabs in the instance.                                                                                       |
| `active_url`   | `str \| null` | URL of the currently active page, or `null` when no pages are open.                                                        |
